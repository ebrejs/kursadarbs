...
<html lang="English">
  <head>
    ...
    <title>V1.lv - internet shop</title>
                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <?php if(isset($_SESSION['username'])) echo '<li><a href="logout.php"><i class="fa fa-user"></i> Logout</a></li>'; else echo '<li><a href="login.php"><i class="fa fa-user"></i> Login</a></li>' ?>
                             <?php if(isset($_SESSION['username'])) echo '<li><a> Sveiks, ' . $_SESSION["username"] . '</a></li>'; ?>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            ...
                            <li class="dropdown dropdown-small">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="index_lv.php">Latviešu</a></li>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="index.php"><span>Internet shop</span></a></h1>
                    </div>
                </div>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2016 V1.lv All Rights Reserved. </p>
                    </div>
                </div>
